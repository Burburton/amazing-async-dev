...
class TestArchiveQueryRuntime:
    ...
    def test_discover_includes_metadata(self, setup_archives):
        ...
        assert auth.get("has_patterns")
        assert auth.get("has_lessons")
        ...
        assert core.get("has_patterns")
        assert not core.get("has_lessons")
