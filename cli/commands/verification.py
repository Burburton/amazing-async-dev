...
def show(
    ...
    if info["browser_required"]:
        ...
        if info["browser_executed"]:
            ...
            console.print("  Executed: No")
            if info["exception_reason"]:
                console.print(f"  Exception Reason: {info['exception_reason']}")
            else:
                console.print("  [yellow]Browser verification not executed[/yellow]")
    ...
    if info["status"] == "failed":
        console.print("  [cyan]retry[/cyan]: Re-run frontend verification")
        ...
        console.print("  [cyan]run[/cyan]: Execute frontend verification recipe")
    else:
        console.print("  [dim]Verification completed[/dim]")
...
def gate(
    ...
    if gate_status == "allowed":
        ...
        console.print("[dim]Execution may proceed to completion[/dim]")
    else:
        console.print("\n[bold red]Gate Status: BLOCKED[/bold red]")
        console.print("[dim]Browser verification required but not completed[/dim]")
...
def retry(
    ...
    console.print("[cyan]Executing frontend verification recipe...[/cyan]")
