...
app.add_typer(notification.app, name="notification", help="Notification management (Feature 080)")
...
app.add_typer(evidence.app, name="evidence", help="Evidence Summary Console - Rolled-up project/feature evidence view (Feature 079)")

app.add_typer(home.app, name="home", help="Operator Home - Unified platform overview")
